...
function App() {
  ...
  return (
    ...
    <div className="flex flex-row w-full h-screen">
      ...
      <h1 className="w-full mx-4 p-1 text-xl bg-fuchsia-400 flex">Recent Chat</h1>    
      </div>
     ...
     Welcome , Let's Chat
         ...
         <div className="w-40 mx-4 h-auto overflow-hidden">{selectedFile && <img className="w-full shadow-md shadow-black h-auto object-cover" src={preview} alt="preview" />}</div>
          ...
          <div className="flex flex-col w-full  ">
            <div className="flex w-full justify-between ">
              <div className="flex flex-row">
                <button className="p-2  rounded-xl mx-1 text-slate-300 bg-slate-600 hover:bg-slate-500 cursor-pointer" onClick={handleOnRecord}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
